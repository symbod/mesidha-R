...
```{r}
remapped_data <- remap_gene_names(data = data, mode = mode, protein_column = protein_column, 
...
```{r}
reduced_data <- reduce_gene_names(data = data, mode = mode, gene_column = gene_column, 
